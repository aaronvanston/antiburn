...
| `provider_incidents` | `provider_incidents=false` | `Unsupported` | No fixture carries a provider capacity or outage record. Upgrade after an explicit API error record is captured as a synthetic fixture. | None |
