...
| `antiburn.quota_incidents_observed`      | Settings → Insights returns an assessed quota-pressure section, once per limit kind whose bucketed hit count differs from the last one reported for that kind during this run.                                                                                                                                                                                                                                                                                                                                                                                                                                                | `label` — `rolling_window`, `weekly`, `model_specific`, `weighted_usage`, `rate_limit`, `usage_limit`, or `provider_capacity`. `bucket` — deduplicated hits for that limit kind. No model name, session identifier, or message text.                                                                                                                                                                          |
